defmodule ElxGistWeb.CoreComponents do
  @moduledoc """
  ...
  def error(assigns) do
    ~H"""
    <p class="mt-3 flex gap-3 text-sm leading-6 text-brand-red">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElxGistWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElxGistWeb.Gettext, "errors", msg, opts)
    end
  end
